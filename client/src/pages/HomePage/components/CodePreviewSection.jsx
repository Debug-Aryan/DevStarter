...
const fileTree = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            type: "folder",
            children: [
              { name: "favicon.ico", icon: "🖼️", color: "text-gray-400", type: "file" },
              { name: "robots.txt", icon: "📄", color: "text-gray-400", type: "file" },
            ],
          },
          {
            name: "src/",
            ...
            children: [
              {
                ...
                type: "folder",
                children: [
                  { name: "Button.tsx", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "Modal.tsx", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "Navbar.tsx", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "Sidebar.tsx", icon: "📝", color: "text-blue-300", type: "file" },
                ],
              },
              {
                name: "pages/",
                ...
                type: "folder",
                children: [
                  { name: "index.tsx", icon: "🏠", color: "text-green-400", type: "file" },
                  { name: "about.tsx", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "dashboard.tsx", icon: "📊", color: "text-purple-400", type: "file" },
                  { name: "settings.tsx", icon: "⚙️", color: "text-gray-400", type: "file" },
                ],
              },
              {
                name: "hooks/",
                ...
                type: "folder",
                children: [
                  { name: "useAuth.ts", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "useFetch.ts", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "useTheme.ts", icon: "📝", color: "text-blue-300", type: "file" },
                ],
              },
              {
                name: "store/",
                ...
                type: "folder",
                children: [
                  { name: "authSlice.ts", icon: "📝", color: "text-blue-300", type: "file" },
              ...
              },
              {
                ...
                children: [
                  ...
                  { name: "helpers.ts", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "validators.ts", icon: "📝", color: "text-blue-300", type: "file" },
                ],
              },
              {
                name: "styles/",
                ...
                type: "folder",
                children: [
                  { name: "globals.css", icon: "🎨", color: "text-pink-400", type: "file" },
                  { name: "variables.css", icon: "🎨", color: "text-pink-400", type: "file" },
                ],
              },
          ...
          { name: "tailwind.config.ts", icon: "💨", color: "text-cyan-400", type: "file" },
            ...
            children: [
              {
                ...
                type: "folder",
                children: [
                  { name: "authController.ts", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "userController.ts", icon: "📝", color: "text-blue-300", type: "file" },
                  { name: "dataController.ts", icon: "📝", color: "text-blue-300", type: "file" },
                ],
              },
              {
                name: "models/",
              ...
              },
              {
                ...
                children: [
                  { name: "auth.ts", icon: "🔐", color: "text-red-400", type: "file" },
                  { name: "errorHandler.ts", icon: "🚨", color: "text-red-400", type: "file" },
                  { name: "rateLimiter.ts", icon: "⏱️", color: "text-orange-400", type: "file" },
              ...
              },
              {
                ...
                type: "folder",
                children: [
                  { name: "database.ts", icon: "🗄️", color: "text-purple-400", type: "file" },
      ...
      },
      {
        ...
        type: "folder",
        children: [
          { name: "types/", icon: "📁", color: "text-yellow-300", type: "folder", children: [
            { name: "index.ts", icon: "📝", color: "text-blue-300", type: "file" },
            { name: "api.types.ts", icon: "📝", color: "text-blue-300", type: "file" },
          ]},
          { name: "constants/", icon: "📁", color: "text-yellow-300", type: "folder", children: [
            { name: "index.ts", icon: "📝", color: "text-blue-300", type: "file" },
          ]},
        ],
      },
      ...
      { name: "docker-compose.prod.yml", icon: "🐳", color: "text-blue-500", type: "file" },
      { name: "README.md", icon: "📄", color: "text-gray-300", type: "file" },
      { name: "package.json", icon: "📦", color: "text-green-400", type: "file" },
      { name: "package-lock.json", icon: "🔒", color: "text-gray-500", type: "file" },
      { name: ".env.example", icon: "🔐", color: "text-yellow-300", type: "file" },
      { name: ".gitignore", icon: "🚫", color: "text-gray-500", type: "file" },
      { name: ".eslintrc.js", icon: "✅", color: "text-purple-400", type: "file" },
      { name: "prettier.config.js", icon: "✨", color: "text-pink-400", type: "file" },
    ],
  },
];
